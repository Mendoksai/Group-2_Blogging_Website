        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-xl max-w-md w-full">
            ...
            <form action="{{ route('post.store') }}" method="post">
                ...
                <div>
                    ...
                    <x-textarea-input required class="w-full h-12 esize-y overflow-y-auto my-1 col-span-5" name="title"
                        placeholder="Enter a title for your post."></x-textarea-input>
