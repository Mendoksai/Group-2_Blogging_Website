                                                  ...
                                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                      ...
                                                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                          ...
                                                          <p id="password-strength-feedback" style="color:red;">Password must contain at least 1 uppercase letter, 1 lowercase letter, 1 number, 1 special character, and be at least 8 characters long</p> 
                                                        </div>
                                                      </div>
                                                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
